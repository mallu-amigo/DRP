...
<head>
    ...
    <link rel="stylesheet" href="../resourcesForm/resource.css">
...
<body>
    ...
    <div class="container">
        ...
        <!-- coding the resource request form -->

        <div class="reporting_box">
            <div class="reporting_header">
                <h2>Request Resources or Help</h2>
            </div>
            <hr>


            <form class="requesting_form">
    ...
    <script src="resourceForm.js"></script>
